...
INPUT_2022="${WORK_DIR}/data/root/Run2022.root"
INPUT_2023="${WORK_DIR}/data/root/Run2023.root"
INPUT_2024="${WORK_DIR}/data/root/Run2024.root"
INPUT_2025="${WORK_DIR}/data/root/Run2025.root"
...
python3 ${WORK_DIR}/scripts/rpc-tnp-plot-eff-detector.py \
  ...
  -s 13.6 \
  -y Run2022 \
  -o ${WORK_DIR}/plots/Run2022WOExclude \
  -l "Private Work" \
  --lumi 34.19 \
  --hide-irpc
...
python3 ${WORK_DIR}/scripts/rpc-tnp-plot-eff-detector.py \
  ...
  -s 13.6 \
  -y Run2023 \
  -o ${WORK_DIR}/plots/Run2023WOExclude \
  -l "Private Work" \
  --lumi 27.50 \
  --hide-irpc
...
python3 ${WORK_DIR}/scripts/rpc-tnp-plot-eff-detector.py \
  ...
  -s 13.6 \
  -y Run2024 \
  -o ${WORK_DIR}/plots/Run2024WOExclude \
  -l "Private Work" \
  --lumi 109.77 \
  --hide-irpc
...
python3 ${WORK_DIR}/scripts/rpc-tnp-plot-eff-detector.py \
  ...
  -s 13.6 \
  -y Run2025 \
  -o ${WORK_DIR}/plots/Run2025WOExclude \
  -l "Private Work" \
  --lumi 110.73 \
  --hide-irpc
