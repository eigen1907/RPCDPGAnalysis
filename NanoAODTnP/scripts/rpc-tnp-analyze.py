...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tree-output", dest="tree_output_path", type=Path,
                        help="Optional flat tree ROOT output path. Default: do not write trees.")
    parser.add_argument("--name", help="NanoAOD table prefix. Default: rpcTnP")
