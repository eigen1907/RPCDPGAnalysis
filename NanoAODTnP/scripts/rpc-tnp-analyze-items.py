...
def output_status(output_eos: str) -> str:
    ...
    try:
        with uproot.open(output_eos) as root_file:
            required = (
                "profile_rpc_fiducial_matched_delta_p_by_probe_p_station",
                "profile_rpc_fiducial_matched_delta_pt_by_probe_pt_station",
                ...
                "count_rpc_fiducial_probe_pt_eta_by_station",
                "count_rpc_fiducial_matched_probe_pt_eta_by_station",
                "profile_rpc_fiducial_matched_cls_by_probe_pt_eta_station",
                "count_rpc_fiducial_probe_at_rpc_pt_eta_by_station",
                "count_rpc_fiducial_matched_probe_at_rpc_pt_eta_by_station",
                "profile_rpc_fiducial_matched_cls_by_probe_at_rpc_pt_eta_station",
            )
